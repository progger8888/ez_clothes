class CfgPatches
{
	class EZ_Melee
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Weapons_Melee_Blade"};
	};
};
class CfgVehicles
{
	class HuntingKnife;
	class EZ_Knife_Syntech: HuntingKnife
	{
		scope = 2;
		displayName = "SYNTech RX-7045 Knife";
		descriptionShort = "Agressive-style knife that might be used in different ways.";
		model = "Inkota\Weapons\Melee\knife1.p3d";
		inventorySlot[] = {"Knife"};
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 130;
					healthLevels[] = {{1.0,{"Inkota\Weapons\Melee\data\knife1.rvmat"}},{0.7,{"Inkota\Weapons\Melee\data\knife1.rvmat"}},{0.5,{"Inkota\Weapons\Melee\data\knife1_damage.rvmat"}},{0.3,{"Inkota\Weapons\Melee\data\knife1_damage.rvmat"}},{0.0,{"Inkota\Weapons\Melee\data\knife1_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
	...
	class EZ_Knife_Swat: HuntingKnife
	{
		scope = 2;
		displayName = "Special Forces Knife";
		descriptionShort = "Knife for IDC using for police officers.";
		model = "Inkota\Weapons\Melee\knife2.p3d";
		inventorySlot[] = {"Knife"};
		repairableWithKits[] = {4};
		repairCosts[] = {10.0};
		rotationFlags = 17;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 130;
					healthLevels[] = {{1.0,{"Inkota\Weapons\Melee\data\knife2.rvmat"}},{0.7,{"Inkota\Weapons\Melee\data\knife2.rvmat"}},{0.5,{"Inkota\Weapons\Melee\data\knife2_damage.rvmat"}},{0.3,{"Inkota\Weapons\Melee\data\knife2_damage.rvmat"}},{0.0,{"Inkota\Weapons\Melee\data\knife2_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
	...
	class EZ_Knife_TacForce: HuntingKnife
	{
		scope = 2;
		displayName = "Tac-Force Knife";
		descriptionShort = "Speedster model from the renowned knife manufacturer Tac-Force.";
		model = "Inkota\Weapons\Melee\knife3.p3d";
		inventorySlot[] = {"Knife"};
		repairableWithKits[] = {4};
		repairCosts[] = {10.0};
		rotationFlags = 17;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				...
				{
					hitpoints = 130;
					healthLevels[] = {{1.0,{"Inkota\Weapons\Melee\data\knife3.rvmat"}},{0.7,{"Inkota\Weapons\Melee\data\knife3.rvmat"}},{0.5,{"Inkota\Weapons\Melee\data\knife3_damage.rvmat"}},{0.3,{"Inkota\Weapons\Melee\data\knife3_damage.rvmat"}},{0.0,{"Inkota\Weapons\Melee\data\knife3_destruct.rvmat"}}};
				};
			};
		};
		isMeleeWeapon = 1;
